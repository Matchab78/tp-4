    ...
    <form action="index.php?uc=continents&action=valideForm" method ="post" class="col-md-6 offset-md-3 border border-dark p-3 rounded">
        ...
        <div class="row">
            <div class="col"><a href="index.php?uc=continents&action=list" class='btn btn-dark btn-block'>Revenir à la liste</a></div>
